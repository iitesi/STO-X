...
<!--- policy : policyair --->
	<cffunction name="policyair" access="remote" output="false" returntype="any">
		...
		<cfargument name="Policy_ID" required="false" type="numeric" default="#session.Policy_ID#"> 
		
		<cfset var getinternational = ''>
		<cfset var policyair = ''>
		
		<cfquery name="getinternational" datasource="Corporate_Production" cachedwithin="#CreateTimespan(0,0,15,0)#">
		SELECT International
		FROM Accounts
		WHERE Acct_ID = <cfqueryparam value="#arguments.Acct_ID#" cfsqltype="cf_sql_integer">
		</cfquery>
		<cfquery name="policyair" datasource="book" cachedwithin="#CreateTimespan(0,0,15,0)#">
		...
		AND Policy_ID = <cfqueryparam value="#arguments.Policy_ID#" cfsqltype="cf_sql_integer">
...
<!--- policy : preferredair --->
	<cffunction name="preferredair" access="remote" output="false" returntype="any">
		...
		<cfset var preferredair = ''>
		
		<cfquery name="preferredair" datasource="book" cachedwithin="#CreateTimespan(0,0,15,0)#">
		SELECT Vendor_Name
...
<!--- policy : policycar --->
	<cffunction name="policycar" access="remote" output="false" returntype="any">
		...
		<cfquery name="policycar" datasource="book" cachedwithin="#CreateTimespan(0,0,15,0)#">
...
<!--- policy : preferredcar --->
	<cffunction name="preferredcar" access="remote" output="false" returntype="any">
		...
		<cfset var preferredcar = ''>
		
		<cfquery name="preferredcar" datasource="book" cachedwithin="#CreateTimespan(0,0,15,0)#">
		SELECT Vendor_Name
		FROM Preferred_Vendors, lu_Vendors
		WHERE Preferred_Vendors.Acct_ID = <cfqueryparam value="#session.account.Acct_ID#" cfsqltype="cf_sql_integer">
...
<!--- policy : preferredcartype --->
	<cffunction name="preferredcartype" access="remote" output="false" returntype="any">
		...
		<cfset var preferredcartype = ''>
		
		<cfquery name="preferredcartype" datasource="book" cachedwithin="#CreateTimespan(0,0,15,0)#">
		SELECT Car_Size
...
<!--- policy : policyhotel --->
	<cffunction name="policyhotel" access="remote" output="false" returntype="any">
		...
		<cfset var policyhotel = ''>
		
		<cfquery name="policyhotel" datasource="book" cachedwithin="#CreateTimespan(0,0,15,0)#">
...
<!--- policy : preferredhotels --->
	<cffunction name="preferredhotels" access="remote" returntype="any" output="false">
		...
		<cfset var preferredhotels = ''>
		
		<cfquery name="preferredhotels" datasource="book" cachedwithin="#CreateTimespan(0,0,15,0)#">
...
<!--- policy : finditpolicy --->
	<cffunction name="finditpolicy" access="remote" output="false" returntype="any">
		...
		<cfset var finditpolicy = ''>
		
		<cfquery name="finditpolicy" datasource="book" cachedwithin="#CreateTimespan(0,0,15,0)#">
