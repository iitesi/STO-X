						...
						<cfelse>
							...
							<cfif (Air.UniversalLocatorCode EQ '')
								...
								<cfif (Air.Total GT originalAirfare) OR (Air.error AND len(Air.UniversalLocatorCode))>
									...
									<cfset arrayAppend( errorMessage, 'One or more segments could not be purchased at this time. If you selected a preferred seat and do not have a valid loyalty number&##44; please pick different seat(s) and try your purchase again. If this problem persists&##44; please contact your travel manager/agent (error code: PA03).' )>
								<cfelse>
