...
--->
							...
							<cfif Air.segmentError>
								...
								<cfset cancelAirResponse(rc, air, local.version)>
							...
							<cfif (Air.UniversalLocatorCode EQ '')
								...
								<cfif (Air.Total GT originalAirfare) OR (Air.error AND len(Air.UniversalLocatorCode))>
									...
									<cfset arrayAppend( errorMessage, 'One or more segments could not be purchased at this time. If you selected a preferred seat and do not have a valid loyalty number (and status with the airline) please pick different seat(s) and try your purchase again. If this problem persists please contact your travel manager/agent (error code: PA03).' )>
								<cfelse>
									...
									<cfset arrayAppend( errorMessage, 'The itinerary selected could not be purchased at this time. Please try your search again. If problem persists&##44; contact your travel manager/agent (error code: PA04).' )>
							 </cfif>
								<cfset errorType = 'Air'>
