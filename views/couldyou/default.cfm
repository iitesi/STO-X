...
<cfoutput>
	...
	<cfloop from="-7" to="7" index="AddDays">
		<tr>
			...
			<cfif AddDays NEQ 0>
				<cfinvoke component="booking.services.couldyou" method="doAirPriceCouldYou" SearchID="#url.SearchID#" nTrip="#AirSelection.nTrip#" sCabin="#AirSelection.Class#" bRefundable="#AirSelection.Ref#" nTripDay="#AddDays#" returnvariable="nTotalPrice">
				<!--- <cfinvoke component="booking.services.couldyou" method="doHotelPriceCouldYou" SearchID="#url.SearchID#" nHotelCode="#HotelSelection.HotelID#" sHotelChain="#HotelChain#" nTripDay="#AddDays#" nNights="#HotelSelection.Nights#" returnvariable="nhotelprice">
				<cfinvoke component="booking.services.couldyou" method="doCarPriceCouldYou" SearchID="#url.SearchID#" nTripDay="#AddDays#" nNights="#HotelSelection.Nights#" sCarChain="#CarSelection.VendorCode#" sCarType="#CarSelection.VehicleClass##CarSelection.Category#" returnvariable="nCarPrice"> --->
				<td>#nTotalPrice#</td>
				<!--- <td>#nhotelprice#</td>
				<td>#nCarPrice#</td>
	...
	<cfloop from="-7" to="7" index="AddDays">
		#DateFormat(DateAdd('d',AddDays,OriginDate),'yyyymmdd')#<cfif AddDays EQ 0> - ORIGINAL</cfif>
			<cfif AddDays NEQ 0>
				<cfif AddDays EQ 1>					
					<cfinvoke component="booking.services.couldyou" method="doCarPriceCouldYou" SearchID="#url.SearchID#" nTripDay="#AddDays#" nNights="#HotelSelection.Nights#"
