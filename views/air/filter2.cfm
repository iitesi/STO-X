				...
				<ul class="nav nav-pills">
					...
					<li role="presentation" class="dropdown" id="filterStops">
						...
						<ul class="dropdown-menu dropdown-menu-right singlefilterwrapper">
							<li>
								<div class="md-radio">
									<input id="stops-a" class="singlefilter" type="radio" name="stops" value="-1" data-title="Any number of stops" title="Any number of stops">
							...
							<li>
								<div class="md-radio">
									<input id="stops-1" showasselected="true" defaultchecked checked class="singlefilter" type="radio" name="stops" value="1" data-title="1 Stop or less" title="1 Stop or less">
					...
					<li role="presentation" class="dropdown" id="filterMore">
						...
						<ul class="dropdown-menu dropdown-menu-right singlefilterwrapper range-slider" data-type="checkbox" data-name="duration" data-selector="trip" data-datafield="duration">
							...
							<li>
								<div class="md-radio">
									<input id="refundable-a" showasselected="false" defaultchecked checked class="singlefilter" type="radio" name="refundable" data-element="fares" value="-1" data-title="Any Fare Type" title="Any Fare Type">
