...
<cfset stTrip = session.searches[rc.Search_ID].stAvailTrips[rc.nTripID]>
<cfset nCnt = ArrayLen(stTrip.Segments)>
<cfoutput>
					...
					<div style="display:table;padding:10px;">
						<div style="display:table-row">
							<div style="table-cell;float:left;">
								<strong>#application.stAirports[stTrip.Segments[1].Origin]# (#stTrip.Segments[1].Origin#)</strong><br><br>
								<strong>#application.stAirports[stTrip.Segments[nCnt].Destination]# (#stTrip.Segments[nCnt].Destination#)</strong><br><br>
							</div>
						</div>
						<div style="display:table-row">
							...
							<div style="table-cell;float:left;">
								#DateFormat(stTrip.Segments[1].DepartureTime, 'ddd, mmm d,')#
								#TimeFormat(stTrip.Segments[1].DepartureTime, 'h:mm tt')#
							</div>
						</div>
						<div style="display:table-row">
							<div style="table-cell; float:left; width:30%;">
							...
							<div style="table-cell;float:left;">
							 	#DateFormat(stTrip.Segments[nCnt].ArrivalTime, 'ddd, mmm d,')#
								#TimeFormat(stTrip.Segments[nCnt].ArrivalTime, 'h:mm tt')#
							</div>
						</div>
						<div style="display:table-row">
							<div style="table-cell;float:left; width:30%;">
