...
<!--- seats --->
			...
			<td width="200" valign="top">
				...
				#(rc.Air.RequestedRefundable ? 'Refundable' : 'No Refunds')#<br>
				<span class="blue bold">
					<a rel="popover" data-original-title="Flight Change / Cancellation Policy" data-content="Ticket is #(rc.Air.RequestedRefundable ? '' : 'non-')#refundable.<br>Change USD #rc.Air.changePenalty# for reissue" href="##" />
