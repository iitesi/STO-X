...
<cfoutput>
	#View('hotel/filter')#
	#View('hotel/map')#
    <a href="#buildURL('hotel.skip?Search_ID=#rc.SearchID#')#">Continue without hotel</a>
...
<!--- <cfinvoke component="services.hotelrooms" method="getRooms" nSearchID="#rc.SearchID#" nHotelCode="#sHotel#" returnvariable="hotel">
<cfdump var="#hotel#" abort> --->
<!--- <a href="http://localhost:8888/booking/services/hotelprice.cfc?method=doHotelPrice&nSearchID=#rc.SearchID#&nHotelCode=#sHotel#&sHotelChain=#HotelChain#" target="_blank">Link</a><br> --->
            </td>
            </tr>
            <tr>
